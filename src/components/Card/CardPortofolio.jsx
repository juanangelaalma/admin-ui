  ...
  return (
    <Card>
      <Wrap width="100%" padding="0" zIndex="2">
        <Title color="#FFF" fontSize="1em" fontWeight="400">My Portofolio</Title>
        <Icon name="chart" color="#FFF"></Icon>
      </Wrap>
      <Wrap width="100%" padding="0.5em 0" zIndex="2">
        <Title color="#FFF" fontSize="2em" fontWeight="500">$45,100.00</Title>
        <Paragraph color="#FFF" alignFlex="flex-end">+2.04%</Paragraph>
      </Wrap>
      <Wrap position="absolute" zIndex="2" width="100%" bottom="-1.8em" left="0" alignItems="center" justifyContent="center">
        <Button padding="0.6em 0.8em" display="flex" justifyContent="center" alignItems="center">
          <svg width="22" height="22" viewBox="0 0 19 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M19 22H0V19.2813H19V22ZM9.5 16.5625L1.35714 8.40634L3.27071 6.48963L8.14286 11.3562V0H10.8571V11.3562L15.7293 6.48963L17.6429 8.40634L9.5 16.5625Z" fill="#474748"/>
          </svg>
